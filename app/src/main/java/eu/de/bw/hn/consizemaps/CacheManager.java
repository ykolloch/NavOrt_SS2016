    ...
    public boolean loadTile(OnlineTileSourceBase tileSource, MapTile tile) {
        ...
        try {
            ...
            if (urlConnection.getResponseCode() != 200) {
                Log.w(TAG, "Problem downloading MapTile: " + tile + " HTTP response: " + urlConnection.getResponseMessage());
                return false;
            }
            ...
            Log.w(TAG, "UnknownHostException downloading MapTile: " + tile + " : " + e);
        } catch (final FileNotFoundException e) {
            Log.w(TAG, "Tile not found: " + tile + " : " + e);
        } catch (final IOException e) {
            Log.w(TAG, "IOException downloading MapTile: " + tile + " : " + e);
    ...
    protected class DownloadingTask extends CacheManagerTask {
        ...
        protected int downloadArea() {
            ...
            if (mTileProvider.getTileSource() instanceof OnlineTileSourceBase)
                ...
                Log.e(TAG, "TileSource is not an online tile source");
                return 0;
            }
